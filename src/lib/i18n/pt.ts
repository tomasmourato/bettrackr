...
export const PT = {
  ...
  "nav.bot": "Bot Betclic",
  "footer.bot": "Bot",
  "bot.title": "Bot da Betclic",
  "bot.subtitle": "Importação automática das apostas da Betclic (privado).",
  "bot.lastSuccess": "Última importação com sucesso",
  "bot.imported30d": "Importadas (30 dias)",
  "bot.failures30d": "Falhas (30 dias)",
  "bot.never": "ainda sem passagens",
  "bot.recentRuns": "Passagens recentes",
  "bot.ok": "OK",
  "bot.failed": "Falhou",
  "bot.read": "lidas",
  "bot.imported": "importadas",
  "bot.duration": "duração",
  "bot.empty": "O bot ainda não reportou nenhuma passagem. Corre-o em casa (ver bot/README.md).",
  "bot.showMore": "Ver mais ({n})",
  "bot.showLess": "Ver menos",
  "bot.runDetails": "Detalhes",
  "bot.runLess": "Menos",
  "bot.runStarted": "Início",
  "bot.runDurationExact": "Duração exata",
  "bot.runReadImported": "Lidas / importadas",
  "bot.runRegistered": "Registado",
  "bot.runId": "ID da passagem",
  "bot.clv.title": "Passagens do agente de CLV",
  "bot.clv.empty": "O agente de CLV ainda não reportou nenhuma passagem. Só o faz a partir da versão com o heartbeat (npm run build:agent).",
  "bot.clv.missingTable": "Falta aplicar a migração db/migrations/026_clv_agent_runs.sql no Supabase.",
  "bot.clv.daily": "Odds do dia",
  "bot.clv.nothingToRead": "nada a ler · {n} por liquidar",
  "bot.clv.matches": "jogos",
  "bot.clv.read": "lidos",
  "bot.clv.written": "apostas escritas",
  "bot.clv.found": "encontrados",
  "bot.clv.withMarket": "com mercado",
  "bot.clv.saved": "gravados",
  "bot.clv.pending": "Por liquidar",
  "bot.clv.captureCounts": "Jogos / lidos / escritas",
  "bot.clv.dailyCounts": "Encontrados / com mercado / gravados",
  ...
  "bot.act.inactive": "Por ativar",
  "bot.act.expires": "expira",
  "bot.act.captureBtn": "Capturar token da extensão",
  "bot.act.orPaste": "ou colar à mão",
  "bot.act.pastePlaceholder": "Cola aqui o token da Betclic (eyJ...)",
  "bot.act.submit": "Ativar",
  "bot.act.deactivate": "Desativar",
  "bot.act.saved": "Bot ativado. O token foi guardado cifrado.",
  "bot.act.deactivated": "Bot desativado.",
  ...
  "bot.act.hide": "Esconder cartão",
  "bot.act.unhide": "Repor cartão",
  "bot.act.hiddenSection": "Contas escondidas ({n})",
  "bot.act.allHidden": "Escondeste todos os cartões. Usa «Contas escondidas» abaixo para os repor.",
  ...
  // Notificações: a página vive na Gestão (/admin?view=notifications) e o
  // aviso de bot parado aparece também no topo do painel do bot.
  "notif.title": "Notificações",
  "notif.subtitle": "Avisos que precisam da tua atenção, como o bot da Betclic parado.",
  "notif.back": "Voltar à gestão",
  "notif.refresh": "Atualizar",
  "notif.empty": "Sem notificações. Se o bot da Betclic parar, o aviso aparece aqui.",
  "notif.loadError": "Não foi possível carregar as notificações.",
  "notif.new": "Nova",
  "notif.open": "Em aberto",
  "notif.resolvedAt": "Resolvido a {date}",
  "notif.unknown": "Notificação",
  "notif.openBot": "Abrir o painel do bot",
  "notif.botStalled.title": "O bot da Betclic parou",
  "notif.botStalled.failing": "O bot continua a correr, mas não importa com sucesso desde {date}.",
  "notif.botStalled.failingNever": "O bot está a correr, mas ainda não teve nenhuma passagem com sucesso.",
  "notif.botStalled.silent": "O bot não reporta desde {date}.",
  "notif.botStalled.lastError": "Último erro",
  "notif.botStalled.hintFailing": "Se o erro fala de token de contexto, a sessão da Betclic expirou: reativa cada conta no painel do bot e a passagem seguinte recupera.",
  "notif.botStalled.hintSilent": "O telemóvel pode ter parado o Termux: corre lá o bot/termux/religar-bot.sh.",
  "notif.push.web": "Os alertas push chegam à app Android.",
  "notif.push.serverOff": "Push por configurar no servidor (falta o FCM_SERVICE_ACCOUNT): os alertas ficam só nesta página.",
  "notif.push.on": "Push ativo neste telemóvel.",
  "notif.push.denied": "As notificações do BetTrackr estão bloqueadas neste telemóvel. Permite-as nas definições do Android.",
  "notif.push.needsApk": "Esta instalação ainda não recebe push: instala o APK novo.",
  "notif.push.pending": "A ligar o push neste telemóvel...",
  "notif.channel.name": "Alertas do bot",
  "notif.channel.description": "Avisa quando o bot da Betclic deixa de importar.",
  "admin.title": "Gestão",
