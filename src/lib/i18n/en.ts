...
export const EN: Record<TKey, Entry> = {
  ...
  "nav.bot": "Betclic Bot",
  "footer.bot": "Bot",
  "bot.title": "Betclic Bot",
  "bot.subtitle": "Automatic import of Betclic bets (private).",
  "bot.lastSuccess": "Last successful import",
  "bot.imported30d": "Imported (30 days)",
  "bot.failures30d": "Failures (30 days)",
  "bot.never": "no runs yet",
  "bot.recentRuns": "Recent runs",
  "bot.ok": "OK",
  "bot.failed": "Failed",
  "bot.read": "read",
  "bot.imported": "imported",
  "bot.duration": "duration",
  "bot.empty": "The bot has not reported any run yet. Run it at home (see bot/README.md).",
  "bot.showMore": "Show more ({n})",
  "bot.showLess": "Show less",
  "bot.runDetails": "Details",
  "bot.runLess": "Less",
  "bot.runStarted": "Started",
  "bot.runDurationExact": "Exact duration",
  "bot.runReadImported": "Read / imported",
  "bot.runRegistered": "Recorded",
  "bot.runId": "Run ID",
  "bot.refresh": "Refresh",
  ...
  "bot.act.inactive": "Not activated",
  "bot.act.expires": "expires",
  "bot.act.captureBtn": "Capture token from the extension",
  "bot.act.orPaste": "or paste manually",
  "bot.act.pastePlaceholder": "Paste the Betclic token here (eyJ...)",
  "bot.act.submit": "Activate",
  "bot.act.deactivate": "Deactivate",
  "bot.act.saved": "Bot activated. The token was stored encrypted.",
  "bot.act.deactivated": "Bot deactivated.",
  ...
  "bot.act.hide": "Hide card",
  "bot.act.unhide": "Restore card",
  "bot.act.hiddenSection": "Hidden accounts ({n})",
  "bot.act.allHidden": "You hid every card. Use “Hidden accounts” below to bring them back.",
  ...
  // Notifications: the page lives in Management (/admin?view=notifications) and
  // the stopped-bot alert also shows at the top of the bot panel.
  "notif.title": "Notifications",
  "notif.subtitle": "Alerts that need your attention, such as the Betclic bot stopping.",
  "notif.back": "Back to management",
  "notif.refresh": "Refresh",
  "notif.empty": "No notifications. If the Betclic bot stops, the alert shows up here.",
  "notif.loadError": "Could not load the notifications.",
  "notif.new": "New",
  "notif.open": "Open",
  "notif.resolvedAt": "Resolved on {date}",
  "notif.unknown": "Notification",
  "notif.openBot": "Open the bot panel",
  "notif.botStalled.title": "The Betclic bot stopped",
  "notif.botStalled.failing": "The bot is still running, but hasn't imported successfully since {date}.",
  "notif.botStalled.failingNever": "The bot is running, but hasn't had a single successful run yet.",
  "notif.botStalled.silent": "The bot hasn't reported since {date}.",
  "notif.botStalled.lastError": "Last error",
  "notif.botStalled.hintFailing": "If the error mentions the context token, the Betclic session expired: reactivate each account in the bot panel and the next run recovers.",
  "notif.botStalled.hintSilent": "The phone may have stopped Termux: run bot/termux/religar-bot.sh there.",
  "notif.push.web": "Push alerts arrive in the Android app.",
  "notif.push.serverOff": "Push isn't set up on the server (FCM_SERVICE_ACCOUNT is missing): alerts only show on this page.",
  "notif.push.on": "Push is on for this phone.",
  "notif.push.denied": "BetTrackr notifications are blocked on this phone. Allow them in the Android settings.",
  "notif.push.needsApk": "This install can't receive push yet: install the new APK.",
  "notif.push.pending": "Connecting push on this phone...",
  "notif.channel.name": "Bot alerts",
  "notif.channel.description": "Alerts you when the Betclic bot stops importing.",
  "admin.title": "Admin",
