...
export const EN: Record<TKey, Entry> = {
  ...
  "bot.runId": "Run ID",
  "bot.clv.title": "CLV agent runs",
  "bot.clv.empty": "The CLV agent has not reported any run yet. Only the version with the heartbeat does (npm run build:agent).",
  "bot.clv.missingTable": "Migration db/migrations/026_clv_agent_runs.sql has not been applied in Supabase yet.",
  "bot.clv.daily": "Daily odds",
  "bot.clv.nothingToRead": "nothing to read · {n} pending",
  "bot.clv.matches": "matches",
  "bot.clv.read": "read",
  "bot.clv.written": "bets written",
  "bot.clv.found": "found",
  "bot.clv.withMarket": "with market",
  "bot.clv.saved": "saved",
  "bot.clv.pending": "Pending",
  "bot.clv.captureCounts": "Matches / read / written",
  "bot.clv.dailyCounts": "Found / with market / saved",
  "bot.refresh": "Refresh",
