...
export default function BetsManager({ 
  ...
  const getSelectionResultBadge = (result?: SelectionDisplayResult) => {
    ...
    switch (result) {
      case "DESCONHECIDO":
        return <span className={`${base} border-amber-200 bg-amber-50 text-amber-700 dark:border-amber-900 dark:bg-amber-950/40 dark:text-amber-300`}><HelpCircle size={10} /> {t("status.unknown")}</span>;
      default:
        return null;
    }
  };
            ...
            <div className="flex shrink-0 items-start justify-between gap-4 border-b border-zinc-100 px-5 py-4 dark:border-zinc-800 sm:px-6">
              <div className="min-w-0">
                ...
                <h2 id="bet-details-title" className="flex items-center gap-2 text-lg font-bold text-zinc-900 dark:text-zinc-100">
                  <Eye size={19} className="text-emerald-500" /> {t("bets.details.title")}
                </h2>
            ...
            <div className="flex-1 space-y-6 overflow-y-auto px-5 py-5 sm:px-6">
              ...
              <section>
                ...
                <div className="grid grid-cols-2 gap-3 sm:grid-cols-5">
                  <div className="rounded-sm border border-zinc-200 p-3 dark:border-zinc-800">
                    <p className="text-[9px] font-bold uppercase text-zinc-400">{t("bets.field.stake")}</p>
                  ...
                  <div className="rounded-sm border border-zinc-200 p-3 dark:border-zinc-800">
                    <p className="text-[9px] font-bold uppercase text-zinc-400">{t("bets.field.totalOdd")}</p>
                  ...
                  <div className="rounded-sm border border-zinc-200 p-3 dark:border-zinc-800">
                    <p className="text-[9px] font-bold uppercase text-zinc-400">{t("bets.field.potential")}</p>
                  ...
                  <div className="rounded-sm border border-zinc-200 p-3 dark:border-zinc-800">
                    <p className="text-[9px] font-bold uppercase text-zinc-400">{t("bets.field.return")}</p>
                  ...
                  <div className="col-span-2 rounded-sm border border-zinc-200 p-3 dark:border-zinc-800 sm:col-span-1">
                    <p className="text-[9px] font-bold uppercase text-zinc-400">{t("bets.field.netProfit")}</p>
                  ...
                  {detailBet.selections.length > 0 ? detailBet.selections.map((selection, index) => {
                    ...
                    <article key={selection.id || index} className={`rounded-sm border p-4 ${selectionDetailClass(displayResult)}`}>
                      <div className="flex flex-col justify-between gap-3 sm:flex-row sm:items-start">
                        <div className="min-w-0">
                          <p className="text-[9px] font-bold uppercase tracking-widest text-zinc-400 dark:text-zinc-500">{t("bets.details.selectionN", { n: index + 1 })}</p>
                ...
                <section className="grid gap-3 sm:grid-cols-2">
                  {detailBet.notes && (
                    <div className="rounded-sm border border-zinc-200 bg-zinc-50 p-4 dark:border-zinc-800 dark:bg-zinc-950/40">
                      <p className="text-[9px] font-bold uppercase tracking-widest text-zinc-400">{t("bets.details.notes")}</p>
                      <p className="mt-1 whitespace-pre-wrap text-xs text-zinc-700 dark:text-zinc-200">{detailBet.notes}</p>
                    </div>
                  )}
                  {detailBet.comment && (
                    <div className="rounded-sm border border-zinc-200 bg-zinc-50 p-4 dark:border-zinc-800 dark:bg-zinc-950/40">
                      <p className="text-[9px] font-bold uppercase tracking-widest text-zinc-400">{t("bets.details.comment")}</p>
                      <p className="mt-1 whitespace-pre-wrap text-xs text-zinc-700 dark:text-zinc-200">{detailBet.comment}</p>
                    </div>
                  )}
                  {detailBet.tags && (
                    <div className="rounded-sm border border-zinc-200 bg-zinc-50 p-4 dark:border-zinc-800 dark:bg-zinc-950/40">
                      <p className="text-[9px] font-bold uppercase tracking-widest text-zinc-400">{t("bets.details.tags")}</p>
