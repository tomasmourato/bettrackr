...
## Corpus Check
- 222 files · ~252,000 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1515 nodes · 3538 edges · 174 communities (101 shown, 73 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 47 edges (avg confidence: 0.86)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7690ac32`
...
Cohesion: 0.16
Nodes (23): ScreenshotImporter(), ScreenshotImporterProps, FormSelection, nowLocal(), useBetForm(), AVAILABLE_BOOKMAKERS, Bookmaker, bookmakerByName() (+15 more)
...
Cohesion: 0.11
Nodes (19): DesktopApp, BrandMark(), AdminDashboard, BetsManager, Dashboard, DesktopApp(), ScreenshotImporter, Settings (+11 more)
...
Cohesion: 0.21
Nodes (10): BackEntry, push(), remove(), runTopBackHandler(), stack, useBackHandler(), BottomSheet(), BottomSheetProps (+2 more)
...
Cohesion: 0.27
Nodes (18): useBets(), fetchMemberBets(), parseJsonResponse(), ApiBetRow, createBet(), createBets(), deleteAllBets(), deleteBet() (+10 more)
...
Cohesion: 0.12
Nodes (30): AccountPanelProps, EN, buildValue(), DICTS, I18nContext, I18nProvider(), I18nValue, interpolate() (+22 more)
...
Cohesion: 0.15
Nodes (17): App(), AppProps, makeInitialLogs(), useAuditLog(), DEFAULT_PREFERENCES, detectLanguage(), loadPreferences(), usePreferences() (+9 more)
...
Cohesion: 0.24
Nodes (8): Gallery, AccountSheet(), GalleryInner(), MobileBets, MobileDashboard, ListGroup(), useToast(), INITIAL_BETS

### Community 101 - "TimeframeFilter.tsx"
Cohesion: 0.17
Nodes (15): now, FilterDropdown(), FilterDropdownOption, FilterDropdownProps, calendarDaysFor(), formatDateKey(), fromLocalDateKey(), RangeEndpoint (+7 more)

### Community 102 - "authApi.ts"
Cohesion: 0.17
Nodes (18): AccountPanel(), AuthPage(), handleSubmit(), AuthPageProps, Mode, changePassword(), clearToken(), CurrentUser (+10 more)
...
Cohesion: 0.20
Nodes (25): BankrollCard(), BankrollCardProps, KINDS, todayKey(), BetsManagerProps, BookieAccountsCard(), BookieAccountsCardProps, DashboardProps (+17 more)

### Community 107 - "Pressable"
Cohesion: 0.21
Nodes (9): tapHaptic(), FAB(), FABProps, ListItemProps, Pressable(), PressableProps, Segment, SegmentedControl() (+1 more)
...
### Community 111 - "BetStatus"
Cohesion: 0.23
Nodes (6): DashboardBetsFilters, FilteredBetsSummary(), FilteredBetsSummaryProps, money(), BetStatus, calculateFilteredBetsSummary()
...
Cohesion: 0.12
Nodes (17): runImport(), umaAposta, cell(), FileReaderShim, header(), reimport(), combineClosingOdds(), validClosingOdd() (+9 more)
...
Cohesion: 0.11
Nodes (23): BetclicImport(), BetclicImportProps, EXTENSION_BOOKIE_KEYS, EXTENSION_BOOKIES, importSummary(), InstallSteps(), loadAccountChoices(), EnabledBookmakersCard() (+15 more)
...
### Community 137 - "useNativeChrome.ts"
Cohesion: 0.36
Nodes (5): exitNativeApp(), setThemeColorMeta(), useAndroidBackButton(), useNativeChrome(), MobileShell()
...
Cohesion: 0.16
Nodes (14): BetsManager(), BULK_MONEY_OPTIONS, BULK_STATUS_OPTIONS, SortDirection, SortField, useUrlFilterSync(), UseUrlFilterSyncOptions, BetSelectionAction (+6 more)
...
Cohesion: 0.24
Nodes (11): CASHOUT_TOKENS, compactStatusToken(), hasCashoutSignal(), isCashoutStatusValue(), normalizeBetStatus(), parseBetMetadata(), STATUS_ALIASES, statusToken() (+3 more)

### Community 150 - "clv.ts"
Cohesion: 0.25
Nodes (16): NOW, betClv(), betClvNoVig(), calculateClv(), ClvBetResult, ClvBookmakerRow, ClvPoint, ClvSummary (+8 more)

### Community 151 - "apiBase.ts"
Cohesion: 0.16
Nodes (11): API_BASE, apiUrl(), configured, fetchBillingStatusOrNull(), getBundleVersion(), initLiveUpdate(), hideSplashScreen(), legacyNameFor() (+3 more)
...
Cohesion: 0.21
Nodes (10): selectionHaptic(), ChipGroupProps, ChipOption, FilterChips(), FilterChipsProps, PullToRefresh(), PullToRefreshProps, SwipeableRow() (+2 more)

### Community 154 - "Dashboard.tsx"
Cohesion: 0.29
Nodes (10): parse(), FiltersBar(), FiltersBarProps, EMPTY_TIMEFRAME_FILTER, isTimeframe(), TimeframeFilterValue, BetFilters, EMPTY_BET_FILTERS (+2 more)

### Community 157 - "ClosingOddsSheet.tsx"
Cohesion: 0.29
Nodes (9): ClosingOddsModal(), ClosingOddsModalProps, describeLeg(), legKey(), ClosingOddInput, ClosingOddsSheet(), ClosingOddsSheetProps, describeLeg() (+1 more)

### Community 158 - "MobileApp.tsx"
Cohesion: 0.25
Nodes (6): MobileApp, MobileBets, MobileDashboard, MobileImport, MobileSettings, MobileSocial

### Community 159 - "safeNum"
Cohesion: 0.43
Nodes (7): Dashboard(), MemberProfile(), MemberProfileProps, statusMeta(), MobileDashboard(), calculateDashboardStats(), safeNum()

### Community 160 - "settingsApi.ts"
Cohesion: 0.50
...
Cohesion: 0.12
Nodes (32): AdminDashboard(), AdminDashboardProps, DeleteDialog(), GrantDialog(), RevokeDialog(), TONE, TrialDialog(), useAdminPanel() (+24 more)
...
- **Why does `combineClosingOdds()` connect `dataTransfer.ts` to `utils.ts`, `BetsManager.tsx`, `clvRoutes.ts`, `clv.ts`, `parseJsonResponse`?**
  _High betweenness centrality (0.120) - this node is a cross-community bridge._
- **Why does `useI18n()` connect `useI18n` to `utils.ts`, `TimeframeFilter.tsx`, `authApi.ts`, `types.ts`, `MobileInsights.tsx`, `BetsManager.tsx`, `BetStatus`, `MobileBets.tsx`, `dataTransfer.ts`, `adminApi.ts`, `isNativeApp`, `authFetch`, `MobileDashboard.tsx`, `Dashboard.tsx`, `index.tsx`, `ClosingOddsSheet.tsx`, `apiBase.ts`, `safeNum`?**
